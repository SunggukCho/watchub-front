<template>
  <section class="glide glide--ltr glide--carousel glide--swipeable">
    <vue-glide
      class="glide__track"
      data-glide-el="track2"
      ref="slider"
      type="carousel"
      :breakpoints="{3000: {perView: 7}, 1500: {perView: 3}, 600: {perView: 1}}">
      <vue-glide-slide v-for="(movie, idx) in Popular" :key="idx">
        <div class="item" data-toggle="modal" data-target="#ModalLong2" data-whatever="@mdo" @click="clickModal(movie)">
